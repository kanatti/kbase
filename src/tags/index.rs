...
impl TagIndex {
    ...
    pub fn all_tags(&self) -> Vec<(&String, usize)> {
        let mut tags: Vec<_> = self.by_tag.iter()
    ...
    pub fn filter_by_domains(&self, domains: &[String]) -> HashMap<String, Vec<String>> {
        ...
        for (tag, paths) in &self.by_tag {
            let domain_paths: Vec<String> = paths.iter()
                .filter(|path| {
...
mod tests {
    ...
    fn create_test_tag_map() -> HashMap<String, Vec<String>> {
        ...
        tags.insert("rust".to_string(), vec!["rust/basics.md".to_string(), "rust/advanced.md".to_string()]);
        tags.insert("wip".to_string(), vec!["rust/basics.md".to_string(), "lucene/study.md".to_string()]);
        tags.insert("deep-dive".to_string(), vec!["lucene/internals.md".to_string()]);
    ...
    fn test_from_tag_map_builds_index() {
        ...
        // Test forward lookup
        assert_eq!(index.notes_with_tag("rust"), vec!["rust/advanced.md", "rust/basics.md"]);
        assert_eq!(index.notes_with_tag("wip"), vec!["lucene/study.md", "rust/basics.md"]);
    ...
    fn test_filter_by_domains() {
        ...
        assert_eq!(rust_only.get("rust").unwrap(), &vec!["rust/advanced.md", "rust/basics.md"]);
    ...
    fn test_save_and_load_json() -> Result<()> {
        ...
        assert_eq!(loaded.notes_with_tag("rust"), original.notes_with_tag("rust"));
