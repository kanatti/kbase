...
static TAG_REGEX: Lazy<Regex> = Lazy::new(|| Regex::new(r"#([a-zA-Z0-9][a-zA-Z0-9_-]*)").unwrap());
...
pub fn extract_tags(content: &str) -> Vec<String> {
    ...
    let mut tag_vec: Vec<String> = tags
        .into_iter()
...
And #another-real tag after.";
    ...
    fn test_various_tag_formats() {
        ...
        assert_eq!(
            tags,
            vec!["123test", "deep-dive", "mix4d2", "rust_lang", "year2024"]
        );
    }
